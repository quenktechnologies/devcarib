...
__this.node('meta', <__wml.Attrs>{'name': 'msapplication-TileColor','content': '#ffffff'}, [
...
__this.node('meta', <__wml.Attrs>{'name': 'theme-color','content': '#ffffff'}, [
...
__this.node('title', <__wml.Attrs>{}, [
        ...
        __document.createTextNode('@title')
     ])
     ]);
