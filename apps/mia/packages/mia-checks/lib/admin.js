 ...
 */
exports.checks = {
    'id': (0, async_1.every)((0, common_checks_1.inc)('counters.admins'), (0, common_checks_1.unique)('admins', 'id')),
 ...
 * check a Admin value.
 */
exports.check = (0, async_1.and)((0, async_1.async)(admin_1.validate), (0, record_1.restrict)(exports.checks));
/**
