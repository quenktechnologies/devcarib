 ...
 */
exports.checks = {
    'id': (0, async_1.every)((0, common_checks_1.unique)('admins', 'id')),
 ...
 * check a Admin value.
 */
exports.check = (0, async_1.and)((0, async_1.and)((0, async_1.async)(admin_1.validate), (0, record_1.restrict)(exports.checks)), (0, async_1.every)((0, common_checks_1.inc)('users')));
/**
 * checkPartial a partial Admin value.
 */
exports.checkPartial = (0, async_1.and)((0, async_1.and)((0, async_1.async)(admin_1.validatePartial), (0, record_1.intersect)(exports.partialChecks)), (0, async_1.every)((0, common_checks_1.inc)('users')));
