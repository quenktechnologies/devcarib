...
import { USER_STATUS_ACTIVE, USER_STATUS_DISABLED } from '@devcarib/server/lib/user/status';

import { AddFormDialog } from '../../../common/scene/dialog/form';
import { AddUserDialogView } from './views/add';

/**
 * AddUserDialog provides a form embeded in a dialog for adding new users.
 */
export class AddUserDialog extends AddFormDialog<User, void> {
