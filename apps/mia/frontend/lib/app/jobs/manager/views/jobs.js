...
exports.JobsManagerView = void 0;
...
var JobsManagerView = /** @class */ (function () {
    function JobsManagerView(__context) {
        this.ids = {};
        this.groups = {};
        this.views = [];
        this.widgets = [];
    ...
    JobsManagerView.prototype.registerView = function (v) {
        this.views.push(v);
        return v;
    };
    JobsManagerView.prototype.register = function (e, attrs) {
        var attrsMap = attrs;
        if (attrsMap.wml) {
    ...
    JobsManagerView.prototype.node = function (tag, attrs, children) {
    ...
    JobsManagerView.prototype.widget = function (w, attrs) {
        this.register(w, attrs);
        this.widgets.push(w);
        return w.render();
    };
    JobsManagerView.prototype.findById = function (id) {
        var mW = (0, maybe_1.fromNullable)(this.ids[id]);
        return this.views.reduce(function (p, c) {
            return p.isJust() ? p : c.findById(id);
        }, mW);
    };
    JobsManagerView.prototype.findByGroup = function (name) {
    ...
    JobsManagerView.prototype.invalidate = function () {
        var tree = this.tree;
    ...
    JobsManagerView.prototype.render = function () {
        this.ids = {};
...
exports.JobsManagerView = JobsManagerView;
