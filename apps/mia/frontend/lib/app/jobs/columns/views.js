    ...
    constructor(__context) {
        ...
        this.template = (__this) => {
            return __this.node('td', {}, [
                __this.widget(new link_1.Link({ 'text': __context.job.title, 'onClick': __context.onClick }, []), { 'text': __context.job.title, 'onClick': __context.onClick })
            ]);
        };
    }
    registerView(v) {
                    ...
                    __this.widget(new menu_1.Menu({}, [
                        ...__forIn(__context.actions, (spec, _$$i, _$$all) => ([
                            ...
                            __this.widget(new item_1.Item({}, [
                                __this.widget(new link_1.Link({ 'text': spec.text, 'onClick': () => spec.onClick(__context.job) }, []), { 'text': spec.text, 'onClick': () => spec.onClick(__context.job) })
                            ]), {})
                        ]), () => ([]))
                    ]), {})
