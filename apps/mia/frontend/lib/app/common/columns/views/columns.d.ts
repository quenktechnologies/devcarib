...
export interface ActionSpec<T extends JSONXObject> {
    text: string;
    divider?: boolean;
    onClick: ($0: T) => void;
}
export interface ActionColumnViewCtx<T extends JSONXObject> {
    actions: (ActionSpec<T>)[];
    data: T;
}
export declare class ActionColumnView<T extends JSONXObject> implements __wml.View {
