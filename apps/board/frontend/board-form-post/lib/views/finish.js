                        ...
                        __this.widget(new grid_1.Row({}, [
                            __this.widget(new grid_1.Column({}, [
                                __this.node('div', { 'class': 'action-container' }, [
                                    __this.widget(new link_1.Link({ 'text': 'See Current Listings', 'className': 'current-listings-link', 'href': '/' }, []), { 'text': 'See Current Listings', 'className': 'current-listings-link', 'href': '/' })
                                ])
                            ]), {})
                        ]), {})
                    ]), { 'span': 8, 'offset': 2 })
