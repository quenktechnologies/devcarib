...
class CompanyFormView {
    constructor(__context) {
        ...
        this.template = (__this) => {
            return __this.node('form', { 'name': 'company-form', 'onsubmit': (e) => e.preventDefault(), 'autocomplete': 'off' }, [
                __this.widget(new panel_1.Panel({}, [
                    __this.widget(new panel_1.PanelBody({}, [
                        __this.registerView(new company_1.JobFormCompanyFieldsView(__context.values.job)).render()
                    ]), {})
                ]), {})
            ]);
        };
