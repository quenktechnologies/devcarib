...
import {JobApplyButtonView} from './button/apply'; 
...
export class JobHeaderView  implements __wml.View {
   ...
   constructor(__context: Job) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('div', <__wml.Attrs>{'id': 'job-header','class': 'ww-grid-layout board-job-header'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'board-job-back-link'}, [
...
__this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__row'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__column -span8 -offset2 board-job-img-wrapper'}, [

        ...(((__context.company_logo) != null) ?
(()=>([

        __this.node('img', <__wml.Attrs>{'class': 'board-job-company-logo','src': __context.company_logo,'alt': 'Company Logo'}, [

        
     ])
     ]))() :
(()=>([]))()),
__this.node('h2', <__wml.Attrs>{'class': 'board-job-title'}, [

        text (__context.title)
     ]),
__this.node('div', <__wml.Attrs>{'class': 'board-job-line'}, [

        
     ]),
__this.node('p', <__wml.Attrs>{'class': 'board-job-company'}, [
