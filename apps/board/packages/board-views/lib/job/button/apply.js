...
var JobApplyButtonView = /** @class */ (function () {
    function JobApplyButtonView(__context) {
        this.ids = {};
        this.groups = {};
        this.views = [];
        this.widgets = [];
        ...
        this.template = function (__this) {
            return __this.node('span', {}, __spreadArray([], (((__context.apply_url) != null) ?
                (function () { return ([
                    __this.node('a', { 'href': __context.apply_url, 'class': 'ww-button -success -large board-job-apply-button', 'target': '_blank' }, [
    ...
    JobApplyButtonView.prototype.register = function (e, attrs) {
        var attrsMap = attrs;
        if (attrsMap.wml) {
    ...
    JobApplyButtonView.prototype.node = function (tag, attrs, children) {
    ...
    JobApplyButtonView.prototype.widget = function (w, attrs) {
    ...
    JobApplyButtonView.prototype.render = function () {
        this.ids = {};
    ...
    return JobApplyButtonView;
}());
exports.JobApplyButtonView = JobApplyButtonView;
