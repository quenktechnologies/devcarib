...
export class JobApplyButtonView  implements __wml.View {
...
(()=>([
        ...
        __this.node('a', <__wml.Attrs>{'href': __context.apply_url,'class': 'ww-button -success -large board-job-apply-button','target': '_blank'}, [
