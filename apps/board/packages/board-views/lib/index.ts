...
__this.node('section', <__wml.Attrs>{'id': 'gayelle','class': 'ww-grid-layout'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__column -span12'}, [

        __this.node('img', <__wml.Attrs>{'class': 'logo-image','height': '100','src': '/assets/img/logo437x437.png','alt': 'Caribbean Developers Logo'}, [
...
__this.node('div', <__wml.Attrs>{'id': 'main','class': 'ww-grid-layout'}, [
