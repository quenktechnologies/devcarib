...
(()=>([]))()),
__this.node('link', <__wml.Attrs>{'rel': "stylesheet",'href': "/assets/css/board.css"}, [

        
     ]),
__this.node('link', <__wml.Attrs>{'rel': "stylesheet",'href': "/assets/vendor/fa/css/fontawesome.min.css"}, [

        
     ]),
__this.node('link', <__wml.Attrs>{'rel': "stylesheet",'href': "/assets/vendor/fa/css/solid.min.css"}, [
