...
export const css:string = '/converse/assets/css/app.css';
export const title:string = 'Deverse';
export class UserView  implements __wml.View {

   constructor(__context: void) {
...
__this.node('script', <__wml.Attrs>{'src': '/converse/assets/js/app.js'}, [
