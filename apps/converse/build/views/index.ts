...
export const title:string = 'Deverse: A Community for Caribbean Software Developers';
export const css:string = '/converse/assets/css/site.css';
...
__this.node('body', <__wml.Attrs>{}, [
        ...
        __document.createTextNode('Deverse')
     ]),
__this.node('p', <__wml.Attrs>{'id': 'subtitle'}, [

        __document.createTextNode('A Community for Caribbean Software Developers')
     ]),
