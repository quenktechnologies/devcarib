...
export class ConverseView  implements __wml.View {
   ...
   constructor(__context: Converse) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(new Nav({ww : { 'className' : 'converse-logout'  }}, [
     ...
     ]),<__wml.Attrs>{ww : { 'className' : 'converse-logout'  }})
     ]),<__wml.Attrs>{'className': 'converse-navbar','links': __context.values.header.links}),
__this.widget(new MainLayout({wml : { 'id' : 'content'  },ww : { 'className' : 'converse-content'  }}, [

        
     ]),<__wml.Attrs>{wml : { 'id' : 'content'  },ww : { 'className' : 'converse-content'  }})
     ]);
