...
export class CreatePostFormView  implements __wml.View {

   constructor(__context: CreatePostForm) {
...
__this.widget(new Row({}, [
        ...
        __this.widget(new PostEditor({'value': __context.values.data,'errors': __context.values.errors,'onChange': __context.values.onChange,'onPost': __context.values.onPost}, [
