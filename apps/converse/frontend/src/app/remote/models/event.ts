...
/**
 * EventRemoteModelRemoteModel.
 * AUTO-GENERATED, DO NOT EDIT DIRECTLY, CHANGES WILL BE LOST!
 */
export class EventRemoteModel extends BaseRemoteModel<Event> {

    create(data: Event): Future<Id> {
    ...
    search(qry: Object): Future<Event[]> {
        ...
        return doFuture(function*() {
            ...
            return pure((r.code === 204) ?
                [] : (<SearchResult<Event>>r.body).data);

        });

    }

    update(id: Id, changes: Partial<Event>): Future<boolean> {
    ...
    get(id: Id): Future<Maybe<Event>> {
        ...
        return doFuture(function*() {
            ...
            return that
                .send(req)
                .chain(res => pure(fromNullable((<GetResult<Event>>res.body).data)))
