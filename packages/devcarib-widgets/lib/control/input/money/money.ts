...
export class CurrencyMoneyTextFieldView  implements __wml.View {
   ...
   constructor(__context: CurrencyMoneyTextField) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(new DropList({'name': __context.values.dropList.name,'options': __context.values.dropList.options,'value': __context.values.dropList.value,'onSelect': __context.values.dropList.onSelect}, [
