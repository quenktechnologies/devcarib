...
export class PostRankPanelView  implements __wml.View {

   constructor(__context: PostRankPanel) {
...
(()=>([
        ...
        __this.widget(new PostStream({'data': __context.values.posts}, [

        
     ]),<__wml.Attrs>{'data': __context.values.posts})
     ]))() :
(()=>([
