...
class PostPanelView {
    constructor(__context) {
        ...
        this.template = (__this) => {
            return __this.widget(new panel_1.Panel({ 'className': "devcarib-post-panel" }, [
                __this.widget(new panel_1.PanelHeader({ 'className': "devcarib-post-panel-header" }, [
                    __this.widget(new metadata_1.PostMetadata({ 'data': __context.values.data }, []), { 'data': __context.values.data }),
                    __this.node('div', { 'class': "devcarib-post-panel-header-links" }, [
                ...
                ]), { 'className': "devcarib-post-panel-header" }),
