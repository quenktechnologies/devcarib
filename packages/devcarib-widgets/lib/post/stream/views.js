...
var PostStreamView = /** @class */ (function () {
    function PostStreamView(__context) {
        this.ids = {};
        this.groups = {};
        this.views = [];
        this.widgets = [];
    ...
    PostStreamView.prototype.register = function (e, attrs) {
        var attrsMap = attrs;
        if (attrsMap.wml) {
    ...
    PostStreamView.prototype.node = function (tag, attrs, children) {
    ...
    PostStreamView.prototype.widget = function (w, attrs) {
        this.register(w, attrs);
        this.widgets.push(w);
        return w.render();
    };
    PostStreamView.prototype.findById = function (id) {
        var mW = (0, maybe_1.fromNullable)(this.ids[id]);
        return this.views.reduce(function (p, c) {
            return p.isJust() ? p : c.findById(id);
        }, mW);
    };
    PostStreamView.prototype.findByGroup = function (name) {
    ...
    PostStreamView.prototype.invalidate = function () {
        var tree = this.tree;
    ...
    PostStreamView.prototype.render = function () {
        this.ids = {};
    ...
    return PostStreamView;
}());
exports.PostStreamView = PostStreamView;
