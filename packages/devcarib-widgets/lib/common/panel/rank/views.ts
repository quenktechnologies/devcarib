...
import {Panel,PanelHeader} from '@quenk/wml-widgets/lib/layout/panel'; ;
import {RankPanel} from '.'; 
...
export class RankPanelView  implements __wml.View {

   constructor(__context: RankPanel) {
