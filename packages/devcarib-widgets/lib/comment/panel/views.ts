...
export class CommentPanelView  implements __wml.View {

   constructor(__context: CommentPanel) {
...
export class EditCommentPanelView  implements __wml.View {
   ...
   constructor(__context: CommentPanel) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.widget(new PostEditor({'notitle': true ,'allowCancel': true ,'value': __context.values.editor.data,'onChange': __context.values.editor.onChange,'onPost': __context.values.editor.onPost,'onCancel': __context.values.editor.onCancel}, [

        
     ]),<__wml.Attrs>{'notitle': true ,'allowCancel': true ,'value': __context.values.editor.data,'onChange': __context.values.editor.onChange,'onPost': __context.values.editor.onPost,'onCancel': __context.values.editor.onCancel});
