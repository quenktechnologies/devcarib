...
export class EventRankPanelView  implements __wml.View {

   constructor(__context: EventRankPanel) {
...
(()=>([
        ...
        __this.widget(new ListLayout({}, [

        ...__forIn (__context.values.events, (event , _$$i, _$$all)=> 
([
