...
export class DevBarView  implements __wml.View {

   constructor(__context: DevBar) {

       this.template = (__this:__wml.Registry) => {

       

           return __this.widget(new ActionBar({'className': __context.values.className}, [

        __this.widget(new Link({'className': __context.values.logo.className,'href': __context.values.logo.target}, [

        __this.widget(new Image({'className': __context.values.logo.image.className,'src': __context.values.logo.image.src,'alt': __context.values.logo.image.alt}, [

        
     ]),<__wml.Attrs>{'className': __context.values.logo.image.className,'src': __context.values.logo.image.src,'alt': __context.values.logo.image.alt})
     ]),<__wml.Attrs>{'className': __context.values.logo.className,'href': __context.values.logo.target}),
...((__context.values.links) ?
(()=>([

        __this.widget(new NavMenu({'items': __context.values.links}, [

        
     ]),<__wml.Attrs>{'items': __context.values.links})
     ]))() :
(()=>([]))()),
...((__context.values.cta) ?
(()=>([

        __this.widget(new Link(__context.values.cta, [

        
     ]),<__wml.Attrs>__context.values.cta)
     ]))() :
(()=>([]))()),
__this.node('div', <__wml.Attrs>{'class': __context.values.cta.className}, [

        ...__forIn (__context.values.cta.links, (attr , _$$i, _$$all)=> 
([

        __this.widget(new Link(attr, [
