...
exports.TitleColumnView = exports.ActionColumnView = void 0;
                ...
                __this.widget(new drop_down_1.DropDown({ ww: { 'className': '-left', 'buttonText': 'Action' } }, [
                    __this.widget(new menu_1.Menu({}, [
                        __this.widget(new item_1.Item({}, [
                            __this.widget(new link_1.Link({ ww: { 'text': 'Approve', 'onClick': __context.approve } }, []), { ww: { 'text': 'Approve', 'onClick': __context.approve } })
                        ]), {}),
                        __this.widget(new item_1.Item({}, [
                            __this.widget(new link_1.Link({ ww: { 'text': 'Remove', 'onClick': __context.remove } }, []), { ww: { 'text': 'Remove', 'onClick': __context.remove } })
                        ]), {})
                    ]), {})
