...
__this.widget(new TextField({html : { 'autocomplete' : 'off'  },'className': '-block','label': 'Password','name': 'password'}, [

        
     ]),<__wml.Attrs>{html : { 'autocomplete' : 'off'  },'className': '-block','label': 'Password','name': 'password'}),
