            ...
            return __this.widget(new panel_1.Panel({}, [
                __this.widget(new panel_1.PanelBody({}, [
                    __this.node('form', { 'autocomplete': 'off', 'action': '/converse/login', 'method': 'POST' }, [
                        ...
                        __this.widget(new text_field_1.TextField({ html: { 'autocomplete': 'off' }, 'className': '-block', 'label': 'Password', 'name': 'password' }, []), { html: { 'autocomplete': 'off' }, 'className': '-block', 'label': 'Password', 'name': 'password' }),
