...
__this.widget(new ModalFooter({}, [
        ...
        __this.widget(new Button({ww : { 'onClick' : __context.onCancel ,'text' : 'Cancel'  }}, [

        
     ]),<__wml.Attrs>{ww : { 'onClick' : __context.onCancel ,'text' : 'Cancel'  }}),
__this.widget(new Button({ww : { 'className' : '-primary' ,'onClick' : __context.onSave ,'text' : 'Save'  }}, [

        
     ]),<__wml.Attrs>{ww : { 'className' : '-primary' ,'onClick' : __context.onSave ,'text' : 'Save'  }})
     ]),<__wml.Attrs>{})
