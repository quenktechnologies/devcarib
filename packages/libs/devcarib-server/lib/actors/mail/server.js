    ...
    MailServer.prototype.queueMessage = function (m) {
        return future_1.doFuture(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.unsafeGetUserConnection('main')];
                    case 1:
                        db = _a.sent();
                        mail = db.collection('mail');
                        return [4 /*yield*/, collection_1.insertOne(mail, m)];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        db = _a.sent();
                        mail = db.collection('mail');
                        return [4 /*yield*/, collection_1.find(mail, {}, { limit: self.options.maxMessagesSent })];
                    case 2:
                        msgs = _a.sent();
                        work = msgs.map(function (msg) {
                            return future_1.liftP(function () { return self.transport.sendMail({
                        ...
                        return [4 /*yield*/, future_1.parallel(work)];
                    case 3:
                        _a.sent();
