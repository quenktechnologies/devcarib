 ...
 */
exports.check = async_1.and(async_1.async(mail_message_1.validate), record_1.restrict(exports.checks));
/**
 * checkPartial a partial MailMessage value.
 */
exports.checkPartial = async_1.and(async_1.async(mail_message_1.validatePartial), record_1.intersect(exports.partialChecks));
