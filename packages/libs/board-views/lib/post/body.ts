...
import {PostFeaturesView} from './features'; 
...
export class PostBodyView  implements __wml.View {
   ...
   constructor(__context: Post) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('div', <__wml.Attrs>{'id': 'main','class': 'ww-grid-layout board-post-body'}, [
        ...
        __this.registerView((new PostFeaturesView(__context))).render(),
__this.node('div', <__wml.Attrs>{'class': 'board-post-timestamp'}, [
...
__this.node('div', <__wml.Attrs>{'class': 'ww-panel__body'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'board-post-salary'}, [
...
__this.node('div', <__wml.Attrs>{'class': 'board-post-html'}, [
