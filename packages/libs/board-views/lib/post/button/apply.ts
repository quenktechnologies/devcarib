...
export class PostApplyButtonView  implements __wml.View {
   ...
   constructor(__context: Post) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('span', <__wml.Attrs>{}, [

        ...(((__context.apply_url) != null) ?
(()=>([

        __this.node('a', <__wml.Attrs>{'href': __context.apply_url,'class': 'ww-button -success -large board-post-apply-button','target': '_blank'}, [
