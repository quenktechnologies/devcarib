...
export interface CandidatePost extends _json.Object {
    ...
    'created_by'?: {
        ...
        'id'?: number, 'username'?: string
    }, 'id'?: number, 'title'?: string, 'preview'?: string, 'description'?: string, 'description_html'?: string, 'company'?: string, 'company_email'?: string, 'company_logo'?: string, 'apply_url'?: string, 'approved'?: boolean
}
