...
export interface CandidatePost extends _json.Object {
    ...
    'created_by'?: {
        ...
        'id'?: number, 'username'?: string
    }, 'id'?: number, 'title'?: string, 'type'?: string, 'location'?: string, 'remote'?: boolean, 'description'?: string, 'description_html'?: string, 'company'?: string, 'company_email'?: string, 'company_logo'?: string, 'apply_url'?: string, 'approved'?: boolean, 'salary_range'?: string
}
