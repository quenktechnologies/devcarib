...
import {PostApplyButtonView} from './button/apply'; 
...
export class PostHeaderView  implements __wml.View {
   ...
   constructor(__context: Post) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('div', <__wml.Attrs>{'id': 'post-header','class': 'ww-grid-layout board-post-header'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'board-post-back-link'}, [
...
__this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__row'}, [
        ...
        __this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__column -span8 -offset2 board-post-img-wrapper'}, [

        ...(((__context.company_logo) != null) ?
(()=>([

        __this.node('img', <__wml.Attrs>{'class': 'board-post-company-logo','src': __context.company_logo,'alt': 'Company Logo'}, [

        
     ])
     ]))() :
(()=>([]))()),
__this.node('h2', <__wml.Attrs>{'class': 'board-post-title'}, [

        text (__context.title)
     ]),
__this.node('div', <__wml.Attrs>{'class': 'board-post-line'}, [

        
     ]),
__this.node('p', <__wml.Attrs>{'class': 'board-post-company'}, [
...
__this.node('div', <__wml.Attrs>{'class': 'ww-grid-layout__row'}, [
        ...
        __this.registerView((new PostApplyButtonView(__context))).render()
     ])
     ])
     ]);
