 ...
 * needed to show more.
 */
const showJobs = (_) => (0, api_1.doAction)(function* () {
 ...
 * page.
 */
const showJobJobPage = (_) => (0, tendril_show_wml_1.render)(new job_form_1.JobFormView({}));
exports.showJobJobPage = showJobJobPage;
/**
 * createJob saves the submitted job data in the database for approval later.
 */
const createJob = (r) => (0, api_1.doAction)(function* () {
 ...
 */
const showJob = (r) => (0, api_1.doAction)(function* () {
