...
const template = ($app) => ({ 'id': `/`, 'app': { 'dirs': { 'self': `/build/app`,
            'public': [`public`, `../../packages/extras/board-views/public`, `../../packages/frontends/board-form-post/public`, `../../packages/frontends/board-admin/public`] }, 'session': { 'enable': true, 'options': { 'secret': process.env['SESSION_SECRET'], 'name': `bscid` },
